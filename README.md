...
> **Exception:** The CMake build scripts in the `CMake/` directory are licensed under the permissive BSD-3-Clause License. See the [COPYING-CMAKE-SCRIPTS](CMake/COPYING-CMAKE-SCRIPTS) file for details
