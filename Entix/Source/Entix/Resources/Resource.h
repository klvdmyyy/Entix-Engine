...
namespace Entix
{
    ...
    public:
        ...
        void Release() {
            if(--m_refCount == 0) {
                EX_LOG(Resources, Error, "TODO: Resource should be unloaded now!!! It's unimplemented functionality!");
                // UnloadInternal();
            }
        }
    ...
    protected:
        ...
        {
            EX_LOG(Resources, Warning, "Resource doesn't support hot-reload: '{}'", ((std::filesystem::path)(m_id)).filename().string());
        }
